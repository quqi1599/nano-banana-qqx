...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({ activeTab, onChangeTab, collapsed = false, mobileOpen, onMobileClose }) => {
    ...
    return (
        <>
            ...
            <aside className={`
                fixed inset-y-0 left-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-r border-cream-200 dark:border-gray-800
            ...
            `}>
                ...
                <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1 scrollbar-hide">
                    ...
                    {navItems.map((item) => {
                        ...
                        const showBadge = 'showBadge' in item && item.showBadge && ticketUnreadCount > 0;
